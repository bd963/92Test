...
//管理员
	...
	public ModelAndView addAdmin(Admin admin,Model model){
		adminService.addAdmin(admin);
		ModelAndView mav = new ModelAndView("admin/successzhu");
		return mav;
	}
	//查询所有管理员
	@RequestMapping(value = "/listadmin",method = {RequestMethod.POST, RequestMethod.GET},produces ="application/json;charset=UTF-8")
	@ResponseBody
	public String listadmin(Model model) {
		List<Admin> list = adminService.adminree();
		JSONObject jsonobj=new JSONObject();
		jsonobj.put("code", 0);
		jsonobj.put("msg", "成功");
		jsonobj.put("count",list.size());
	    ...
	    for(Admin admin:list) {
	    	jsonobj3.put("id",admin.getId());
	    	jsonobj3.put("name",admin.getName());
	    	jsonobj3.put("username",admin.getUsername());
	    	jsonobj3.put("password",admin.getPassword());
	    	jsonobj2.add(jsonobj3);
	    }
	    jsonobj.put("data", jsonobj2);		
		return jsonobj.toString();
	...
	//管理员信息的模糊查询
	@RequestMapping(value = "/mohunameteae",method = {RequestMethod.POST, RequestMethod.GET},produces ="application/json;charset=UTF-8")
	@ResponseBody
	public String mohunameteae(HttpSession session) {
		@SuppressWarnings("unchecked")
		List<Admin> list=(List<Admin>) session.getAttribute("admlist");
		JSONObject jsonobj=new JSONObject();
		jsonobj.put("code", 0);
		jsonobj.put("msg", "成功");
		jsonobj.put("count",list.size());
