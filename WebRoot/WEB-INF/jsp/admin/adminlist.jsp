...
<table class="layui-table" lay-data="{width: 1200, height:500, url:'listadmin', page:true, id:'idTest'}" lay-filter="demo">
  <thead>
    <tr>
...
layui.use(['table','layer'], function(){
  ...
  table.on('tool(demo)', function(obj){
    ...
    if(obj.event === 'del'){
    	...
    	window.location.href="hrefxiuadm?id="+data.id+"";
    }
  });
  var $ = layui.$, active = {
    checkname: function(){ //弹出对话框
    	layer.prompt({title:'请输入名字的一部分'},function(value){
    		window.location.href="hrefmohunameadm?name="+value+""; 
    	});
    }
  };	
